...
*
\****************************************************************************/
int E4000_gain_freq(rtl2832* pTuner, int Freq)
{
	unsigned char writearray[5];
	int status;
...
*
\****************************************************************************/
int GainControlinit(rtl2832* pTuner)
{
	unsigned char writearray[5];
	unsigned char read1[1];
	int status;
...
*
\****************************************************************************/
int PLL(rtl2832* pTuner, int Ref_clk, int Freq)
{
	int VCO_freq;
	unsigned char writearray[5];
	int status;
...
int LNAfilter(rtl2832* pTuner, int Freq)
{
	unsigned char writearray[5];
	int status;
...
*
\****************************************************************************/
int IFfilter(rtl2832* pTuner, int bandwidth, int Ref_clk)
{
	unsigned char writearray[5];
	int status;
...
*
\****************************************************************************/
int freqband(rtl2832* pTuner, int Freq)
{
	unsigned char writearray[5];
	int status;
...
*
\****************************************************************************/
int GainControlauto(rtl2832* pTuner)
{
	unsigned char writearray[5];
	int status;
...
int E4000_sensitivity(rtl2832* pTuner, int Freq, int bandwidth)
{
...
*
\****************************************************************************/
int E4000_linearity(rtl2832* pTuner, int Freq, int bandwidth)
{
...
*
\****************************************************************************/
int E4000_nominal(rtl2832* pTuner, int Freq, int bandwidth)
{
	unsigned char writearray[2];
	int status;
	int IF_BW;
